...
public final class JSObject {
    ...
    public static JSObject newObject(JSObject proto) {
        return new JSObject(proto, "object", (_, _) -> {
            throw new Failure("object can not be invoked");
        });
    }

    public static JSObject newEnv(JSObject parent) {
        return new JSObject(parent, "env", (_, _) -> {
            throw new Failure("env can not be invoked");
        });
    }
